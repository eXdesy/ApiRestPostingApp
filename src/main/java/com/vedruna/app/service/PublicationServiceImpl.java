...
public class PublicationServiceImpl implements PublicationServiceI {
     ...
     * @param image imagen que representa la nueva publicación.
     * @return DTO que representa la publicación creada.
     */
    @Override
    public PublicationDTO createPublication(Long userId, PublicationDTO publicationDTO, MultipartFile image) {
        ...
        if (image != null && !image.isEmpty()) {
            try {
                publicationEntity.setImage(image.getBytes());
            } catch (IOException e) {
     ...
     * @param image  imagen que representa la publicación editada.
     * @return DTO que representa la publicación editada.
     */
    @Override
    public PublicationDTO editPublication(Long userId, Long publicationId, PublicationDTO publicationDTO, MultipartFile image) {
        UserDTO authenticatedUser = userService.getAuthenticatedUser();
