...
public interface PublicationServiceI {
     ...
     * @param image  DTO que representa la nueva imagen.
     * @return DTO que representa la publicación creada.
     */
    PublicationDTO createPublication(Long userId, PublicationDTO publicationDTO, MultipartFile image);
     ...
     * @param image  DTO que representa la imagen editada.
     * @return DTO que representa la publicación editada.
     */
    PublicationDTO editPublication(Long userId, Long publicationId, PublicationDTO publicationDTO, MultipartFile image);
