package com.vedruna.app.controller;
...
import com.vedruna.app.dto.PublicationDTO;
import com.vedruna.app.dto.UserDTO;
import com.vedruna.app.service.CommentServiceI;
import com.vedruna.app.service.FollowServiceI;
import com.vedruna.app.service.PublicationServiceI;
import com.vedruna.app.service.UserServiceI;
...
/**
 * Controlador que gestiona las operaciones.
 */
@Slf4j
@RestController
@MultipartConfig
...
public class ApplicationController {
    ...
    private final FollowServiceI followService;
    ...
    /**
     * Constructor de la clase ApplicationController.
     *
     ...
     */
    @Autowired
    public ApplicationController(UserServiceI userService, FollowServiceI followService,
     ...
     * @param image  Imagen detalles de la publicación a crear.
    ...
    public ResponseEntity<PublicationDTO> createPublication(@PathVariable(name = "userId") Long userId,
        ...
        try {
            ...
            PublicationDTO createdPublication = publicationService.createPublication(userId, publicationDTO, image);
     ...
     * @param image  Imagen detalles de la publicación.
     * @return ResponseEntity con PublicationDTO y el estado HTTP correspondiente.
     */
    ...
    public ResponseEntity<PublicationDTO> editPublication(@PathVariable(name = "userId") Long userId,
                                                         @PathVariable(name = "publicationId") Long publicationId,
                                                          @RequestParam(value = "image", required = false) MultipartFile image,
                                                          @ModelAttribute(value = "text") PublicationDTO publicationDTO) {
        try {
            PublicationDTO editedPublication = publicationService.editPublication(userId, publicationId, publicationDTO, image);
     ...
     * @param image    imagen que contiene la información del comentario.
